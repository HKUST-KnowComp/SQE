...
def sample_29_test_data(id):

    n_queries_test_dict = n_queries_train_dict_big#[20,20,20]
    ...
    for data_dir in n_queries_test_dict.keys():
        ...
        for query_type, sample_pattern in original_query_types.items():
            ...
            with open("/home/data/jbai/sampled_data_29_train/" + data_dir + "_" + query_type + "_train_queries_" + str(id) + ".json", "w") as file_handle:
...
if __name__ == "__main__":
    ...
    with Pool(num_processes) as p:
        print(p.map(sample_29_test_data, range(num_processes)))
